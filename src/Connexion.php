...
<html>
  ...
  <body>
      <header><br><h1>Rentrez vos identifiants pour vous connecter</h1> <br><br></header> <!--lbl  -->
      <br><br><br><br><br>
	   ...
	   <div class="message">
		  ...
		  <!--Création des txtbox pour l'envoi du formulaire-->
      ...
      <?php
          if(isset($_POST['username'],$_POST['password'] )){
            ...
            if($count==0) {
                  ...
                  //echo $message ;
                  echo "<p style='color:red;'>Mot de passe ou username incorrect.";
                        }
            else {
